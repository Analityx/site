    ...
    return (
        ...
        >
            <motion.div
                ...
                <h1 className="title-header max-2xl:text-[7em] max-xl:text-[5em] max-md:text-[3em] text-left text-white w-1/2  max-sm:text-[2.5em] uppercase leading-[0.9] max-sm:leading-8 tracking-tighter">
